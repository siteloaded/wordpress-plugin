...
namespace SiteLoaded\Vendor\Milo\Github {
	/**
	 * Marker interface.
	 */
...
namespace SiteLoaded\Vendor\Milo\Github\Http {
...
namespace SiteLoaded\Vendor\Milo\Github\OAuth {
	use SiteLoaded\Vendor\Milo\Github;
...
namespace SiteLoaded\Vendor\Milo\Github\Storages {
	use SiteLoaded\Vendor\Milo\Github;
