 ...
 */
namespace SiteLoaded\Vendor\Masterminds\HTML5\Serializer;

use SiteLoaded\Vendor\Masterminds\HTML5\Elements;

/**
 * Generate the output html5 based on element rules.
 */
class OutputRules implements \SiteLoaded\Vendor\Masterminds\HTML5\Serializer\RulesInterface
{
    /**
    ...
    public function setTraverser(\SiteLoaded\Vendor\Masterminds\HTML5\Serializer\Traverser $traverser)
    {
    ...
    protected function enc($text, $attribute = false)
    {
        ...
        // This manually handles them.
            ...
            return strtr($text, \SiteLoaded\Vendor\Masterminds\HTML5\Serializer\HTML5Entities::$map);
        }
    }
