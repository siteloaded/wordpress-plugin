<?php
namespace SiteLoaded\Vendor\Masterminds;

use SiteLoaded\Vendor\Masterminds\HTML5\Parser\FileInputStream;
use SiteLoaded\Vendor\Masterminds\HTML5\Parser\StringInputStream;
use SiteLoaded\Vendor\Masterminds\HTML5\Parser\DOMTreeBuilder;
use SiteLoaded\Vendor\Masterminds\HTML5\Parser\Scanner;
use SiteLoaded\Vendor\Masterminds\HTML5\Parser\Tokenizer;
use SiteLoaded\Vendor\Masterminds\HTML5\Serializer\OutputRules;
use SiteLoaded\Vendor\Masterminds\HTML5\Serializer\Traverser;
...
class HTML5
{
     ...
     */
    public function parse(\SiteLoaded\Vendor\Masterminds\HTML5\Parser\InputStream $input, array $options = array())
    {
        $this->errors = array();
     ...
     * of a string, file, or resource.
     */
    public function parseFragment(\SiteLoaded\Vendor\Masterminds\HTML5\Parser\InputStream $input, array $options = array())
    {
        $options = array_merge($this->getOptions(), $options);
